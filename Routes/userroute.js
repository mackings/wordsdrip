...
const { Addbook, getBooks , getBooksbyid , Searchbooks, findmybooks, addchapter, Searchtags, viewbook} = require("../Bookscontroller/bookscontroller");
...
router.post("/Viewbook/:id", viewbook);
